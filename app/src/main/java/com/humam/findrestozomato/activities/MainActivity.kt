package com.humam.findrestozomato.activities
...
import com.humam.findrestozomato.adapter.MainAdapter
import com.humam.findrestozomato.adapter.MainAdapterHoriontal
import com.humam.findrestozomato.model.ModelMain
import com.humam.findrestozomato.model.ModelMainHorizontal
import com.humam.findrestozomato.networking.ApiEndpoint
import com.humam.findrestozomato.utils.OnItemClickCallback
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    private var mainAdapterHorizontal: MainAdapterHoriontal? = null
...
//        }
        ...
        if (myVersion > Build.VERSION_CODES.LOLLIPOP_MR1) {
            if (checkAlreadyhavePermission() && checkAlreadyhavePermission2()) {
            } else {
    ...
    private fun showRecyclerResto() {
        mainAdapterHorizontal = MainAdapterHoriontal(this, modelMainHorizontal)
        ...
        rvRestaurantNearby.setLayoutManager(LinearLayoutManager(this))
        rvRestaurantNearby.setHasFixedSize(true)
        rvRestaurantNearby.setAdapter(mainAdapter)
    ...
    private fun setSearchResto(query: String?) {
        mProgressBar?.show()
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.Search + query + "&lat=" + lat + "&lon=" + lng + "&radius=2000")
            .addHeaders("user-key", "acccd9ca681374366d0b5f39ecd19025")
                ...
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        for (i in 0 until jsonArray.length()) {
                            ...
                            dataApi.imgeUrl = jsonObjectData.getString("image_url")
    ...
    private fun checkAlreadyhavePermission(): Boolean {
        val result = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
        return result == PackageManager.PERMISSION_GRANTED
    }

    private fun checkAlreadyhavePermission2(): Boolean {
    ...
    companion object {
        fun setWindowFlag(activity: Activity, bits: Int, on : Boolean) {
            ...
            if (on) {
                ...
                layoutParams.flags = layoutParams.flags or bits.inv()
            }
